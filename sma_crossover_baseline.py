...
def run_all_sma_baselines(symbols=('btc', 'eth', 'xrp')):
    ...
    table5_benchmarks = {
        'BTC': [
            {'Algorithm': 'DQN (5-Action)', 'Strategy': 'Neuro-Symbolic', 'Return (%)': '-27.06%', 'Sharpe': '-2.9127', 'Sortino': '-2.8651', 'Max Drawdown': '-32.83%', 'Trades': 818, 'Safety Blocks': 119},
        ...
        'ETH': [
            {'Algorithm': 'DQN (5-Action)', 'Strategy': 'Neuro-Symbolic', 'Return (%)': '-17.79%', 'Sharpe': '-1.3689', 'Sortino': '-1.2691', 'Max Drawdown': '-31.60%', 'Trades': 314, 'Safety Blocks': 114},
        ...
        'XRP': [
            {'Algorithm': 'DQN (5-Action)', 'Strategy': 'Neuro-Symbolic', 'Return (%)': '-33.39%', 'Sharpe': '-2.9108', 'Sortino': '-2.8623', 'Max Drawdown': '-35.08%', 'Trades': 572, 'Safety Blocks': 211},
