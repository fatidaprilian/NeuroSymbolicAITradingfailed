...
| **Proposed Framework** | BTC, ETH, XRP | NeSy 5-Action DQN (LR-LSTM + 5-DQN + Adaptive Veto) | Distribution-Calibrated ATR/RSI/SMA Action Shield | Paired t-test, Wilcoxon, Bootstrap | Resolves zero-trade policy stagnation: 818 trades on BTC, +10.80% PnL on XRP, 9.30% MDD reduction on ETH, 444 active veto triggers across assets. |
"""
...
Pasar mata uang kripto yang sangat volatil dan *non-stationary* sering menyebabkan masalah *reward hacking* dan instabilitas kebijakan pada agen *Deep Q-Network* (DQN) 3-aksi standar akibat gesekan biaya transaksi. Penelitian ini mengajukan arsitektur *Neuro-Symbolic AI* hibrida berbasis *5-Action Discrete Space* $\{0: \text{SELL 100\%}, 1: \text{SELL 50\%}, 2: \text{HOLD}, 3: \text{BUY 50\%}, 4: \text{BUY 100\%}\}$ yang menggabungkan prediktor harga *Linear Regression-LSTM*, agen *Deep Q-Network* (DQN), dan *symbolic safety net* terkalibrasi persentil distribusi (NATR, RSI, SMA) sebagai mekanisme *veto* deterministik. Evaluasi eksperimental dilakukan pada data 1-jam aset Bitcoin (BTC), Ethereum (ETH), dan Ripple (XRP) periode 2021-2026 dengan biaya transaksi 0,1%. Hasil pengujian menunjukkan bahwa arsitektur *Neuro-Symbolic 5-Action DQN* berhasil mengatasi *policy stagnation* melalui 818 eksekusi transaksi pada BTC, 314 pada ETH, dan 572 pada XRP. Agen *Neuro-Symbolic* melampaui performa *baseline DQN* murni sebesar +10,80% pada XRP (-33,39% vs -44,19%) serta menekan *Maximum Drawdown* (MDD) pada ETH dari -40,90% menjadi -31,60% dan pada XRP dari -45,58% menjadi -35,08%. Lapisan pengaman simbolik secara empiris memicu 444 blokir penyelamatan modal (119 BTC, 114 ETH, 211 XRP) terhadap sinyal beli berisiko tinggi saat pasar sedang turun, serta memberikan log *auditability Explainable AI* (XAI) secara *real-time*.

### English Version
Highly volatile and non-stationary cryptocurrency markets often induce reward hacking and policy stagnation in standard 3-action Deep Q-Network (DQN) agents under transaction fee friction. This paper proposes a hybrid Neuro-Symbolic AI architecture utilizing a 5-Action Discrete Unit Space $\{0: \text{SELL 100\%}, 1: \text{SELL 50\%}, 2: \text{HOLD}, 3: \text{BUY 50\%}, 4: \text{BUY 100\%}\}$ that integrates a Linear Regression-LSTM price predictor, a Deep Q-Network (DQN) agent, and a distribution-calibrated symbolic safety net (NATR, RSI, SMA) as a deterministic action shield. Experimental evaluation was conducted on 1-hour historical data across Bitcoin (BTC), Ethereum (ETH), and Ripple (XRP) for 2021-2026 under realistic 0.1% transaction fees. Results demonstrate that the 5-Action Neuro-Symbolic DQN architecture successfully resolved zero-trade policy stagnation, achieving 818 active trade executions on BTC, 314 on ETH, and 572 on XRP. The Neuro-Symbolic agent outperformed pure baseline DQN by +10.80% in cumulative return on XRP (-33.39% vs -44.19%) while reducing Maximum Drawdown (MDD) on ETH from -40.90% to -31.60% and on XRP from -45.58% to -35.08%. The symbolic safety net empirically triggered 444 capital-preservation veto blocks (119 BTC, 114 ETH, 211 XRP) against high-risk buy signals during volatile downtrends, providing real-time Explainable AI (XAI) audit logs.
"""
