...
3. **Multi-Algorithm Validation (Double DQN)**:
   ...
   - On **ETH**, the Pure Baseline Double DQN performed marginally better than Neuro-Symbolic (-17.74% vs -23.62%), indicating that safety net sensitivity interacts uniquely with overestimation mitigation mechanics and momentum profiles across individual assets. Future work will investigate algorithm-adaptive threshold calibration.
